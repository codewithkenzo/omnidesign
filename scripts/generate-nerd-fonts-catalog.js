...
function generateJsDelivrUrl(font) {
  ...
  const folderName = specialCases[dirName] || dirName.charAt(0).toUpperCase() + dirName.slice(1);
...
function generateGitHubReleaseUrl(font) {
  ...
  const zipFile = specialCases[zipName] || (zipName.charAt(0).toUpperCase() + zipName.slice(1));
...
function generateInstallCommands(font) {
  return {
    macos: font.homebrewName ? `brew install --cask ${font.homebrewName}` : null,
...
const catalog = {
  ...
  categories: {
    programming: {
      ...
      recommendations: ["jetbrains-mono-nerd", "fira-code-nerd", "caskaydia-cove-nerd", "caskaydia-mono-nerd", "zed-mono-nerd"]
    },
    terminal: {
      description: "Fonts designed for terminal use with powerline symbols and compact designs",
      recommendations: ["iosevka-term-nerd", "meslo-lg-nerd", "terminus-nerd", "ubuntu-mono-nerd"]
    },
    dense: {
      description: "Narrow fonts for maximum information density",
      recommendations: ["iosevka-nerd", "iosevka-term-nerd", "proggy-clean-nerd", "terminus-nerd"]
    },
    retro: {
    ...
    creative: {
      ...
      recommendations: ["victor-mono-nerd", "fantasque-sans-mono-nerd", "comic-shanns-mono-nerd", "recursive-mono-nerd"]
    },
    accessible: {
    ...
    minimal: {
      ...
      recommendations: ["geist-mono-nerd", "jetbrains-mono-nerd", "blex-mono-nerd", "commit-mono-nerd"]
    },
    "google-fonts": {
      description: "Fonts available on Google Fonts for easy web integration",
      recommendations: ["jetbrains-mono-nerd", "fira-code-nerd", "space-mono-nerd", "roboto-mono-nerd", "inconsolata-nerd", "ubuntu-mono-nerd", "source-code-pro-nerd"]
    }
  },
  fontPairings: {
    "modern-dev": {
