...
<svg width="400" height="80" viewBox="0 0 400 80" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="296" y="56" class="color-value" text-anchor="middle">${colors.primary.substring(0, 15)}</text>
  ...
  <text x="332" y="56" class="color-value" text-anchor="middle">${colors.surfaceRaised.substring(0, 15)}</text>
  
  <!-- Text color swatch -->
  <rect x="352" y="12" width="32" height="32" rx="8" fill="${colors.text}" filter="url(#shadow)"/>
  <text x="368" y="56" class="color-value" text-anchor="middle">${colors.text.substring(0, 15)}</text>
</svg>`;
}
